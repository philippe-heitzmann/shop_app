...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _saveForm() {
    ...
    if (_editedProduct.id != '') {
      ...
      final productData = Provider.of<Products>(context, listen: false).addProduct(
          _editedProduct); //listen set to false because don't want to listen and react to change to Products, only want to dispatch the addProduct method one time
    }
